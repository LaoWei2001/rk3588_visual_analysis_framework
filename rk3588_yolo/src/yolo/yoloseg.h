...
private:
    ...
    int post_process(rknn_output* outputs, LetterBoxInfo& lb, int ori_in_width, int ori_in_height, std::vector<AlgoResult>& results);
    
    int process_i8(rknn_output *all_input, int input_id, const int *anchor, int grid_h, int grid_w, int height, int width, int stride,
                                            int class_num,
    ...
    int process_fp32(rknn_output *all_input, int input_id, const int *anchor, int grid_h, int grid_w, int height, int width, int stride,
                                                int class_num,
                        std::vector<float> &boxes, std::vector<float> &segments, float *proto, std::vector<float> &objProbs, std::vector<int> &classId, float threshold);
