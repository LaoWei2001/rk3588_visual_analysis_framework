...
extern "C"
{
    ...
    /* Pipe Settings */
    RK_S32 RK_MPI_AVS_SendPipeFrame(AVS_GRP AVSGrp, AVS_PIPE AVSPipe, const VIDEO_FRAME_INFO_S *pstVideoFrame,
                                    RK_S32 s32MilliSec);
    RK_S32 RK_MPI_AVS_GetPipeFrame(AVS_GRP AVSGrp, AVS_PIPE AVSPipe, VIDEO_FRAME_INFO_S *pstVideoFrame);
    RK_S32 RK_MPI_AVS_ReleasePipeFrame(AVS_GRP AVSGrp, AVS_PIPE AVSPipe, const VIDEO_FRAME_INFO_S *pstVideoFrame);
    ...
    RK_S32 RK_MPI_AVS_GetChnFrame(AVS_GRP AVSGrp, AVS_CHN AVSChn, VIDEO_FRAME_INFO_S *pstVideoFrame,
                                  RK_S32 s32MilliSec);
    RK_S32 RK_MPI_AVS_ReleaseChnFrame(AVS_GRP AVSGrp, AVS_CHN AVSChn, const VIDEO_FRAME_INFO_S *pstVideoFrame);
