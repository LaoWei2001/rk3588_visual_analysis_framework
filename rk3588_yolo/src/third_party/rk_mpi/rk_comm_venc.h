...
#define RC_TEXTURE_THR_SIZE 16
    ...
    typedef struct rkVENC_SLICE_SPLIT_S
    {
        ...
        /* RW; this value presents slice split mode;0:slice is split by byte
         * number;1:slice is split by mb/ctu number*/
        RK_U32 u32SplitMode;
    ...
    typedef struct rkVENC_H264_TRANS_S
    {
        ...
        RK_BOOL bScalingListValid;     /* RW; Range:[0,1]; enable Scaling,default:
                                          RK_FALSE  */
    ...
    typedef struct rkVENC_H265_TRANS_S
    {
        ...
        RK_BOOL bScalingListEnabled; /* RW; Range:[0,1]; If 1, specifies that a
                                        scaling list is used.*/
