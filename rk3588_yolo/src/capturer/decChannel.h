...
public:
    ...
    int32_t channelId() const { return mGstChn.chnIds.empty() ? -1 : mGstChn.chnIds[0]; }
    void reconnect();
    void resetReconnectCount() { mReconnectCount = 0; }
    void addTargetChannel(int chnId) { mGstChn.chnIds.push_back(chnId); }
