/**
 * @file rkvision/global_context.h
...
#include <rkvision/snapshots.h>
#include <rkvision/events.h>
#include <rkvision/actions.h>
...
struct GlobalContext
{
    ...
    bool get_channel_frame_snapshot(int configured_id, ChannelFrameSnapshot *out) const
    {
        ...
        return out && expected && rkvision_detail::app_ctrl_get_channel_frame_snapshot(configured_id, out) != 0 &&
