...
- 涉及文件：`uploader/alarm_uploader.{h,cpp}`、`config/config_init.cpp`、`logic/channel_logic.cpp`（各 enqueue 调用点）。
...
1. 在 `src/logic/channel_logic.cpp` 实现函数：
   ```cpp
